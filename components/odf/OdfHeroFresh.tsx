...
export default function OdfHeroFresh(): JSX.Element {
  ...
  return (
    <section className="relative overflow-hidden text-white" style={{ background: "#0A0A0A" }}>
      <div className="container mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8 min-h-[600px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-stretch py-16 md:py-20">
          {/* LEFT: Black card with yellow accent */}
          <div className="flex flex-col justify-center order-1 lg:order-1">
            <div className="inline-flex items-center gap-4 md:gap-5 rounded-full border border-white/15 bg-white/10 px-5 md:px-6 py-2.5 md:py-3 backdrop-blur-md ring-1 ring-white/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
              <img src="/logos/ondeck.svg" alt="On Deck" className="h-8 md:h-10 w-auto opacity-95" />
            ...
            <div className="mt-5 relative max-w-[640px] rounded-2xl border border-white/12 bg-[#0A0A0A] p-6 md:p-7 shadow-[0_20px_60px_rgba(0,0,0,0.45)] ring-1 ring-white/5 overflow-hidden">
              ...
              <div className="mt-5">
                <button onClick={() => setNoteOpen(true)} className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/8 px-4 py-2.5 text-sm md:text-[15px] text-white/90 hover:text-white transition-all hover:shadow-[0_0_0_2px_rgba(255,255,255,0.08)]">
              ...
              <div className="mt-3">
                <a href="https://form.typeform.com/to/dub8wybg" className="inline-flex items-center rounded-full bg-[#FACC15] text-black px-6 py-3 font-semibold shadow-[0_10px_28px_rgba(250,204,21,0.28)] hover:shadow-[0_16px_40px_rgba(250,204,21,0.38)]">
                  Claim 1 of 10 Slots
                </a>
              </div>
            </div>
          ...
          {/* RIGHT: Original headline + bullets + chips + intro card */}
          <div className="flex flex-col justify-center order-2 lg:order-2">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <span className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-3 py-1 text-sm text-white/85 backdrop-blur"><span className="mr-2 inline-block h-2 w-2 rounded-full bg-[#8FD14F]"></span>AI Citations</span>
              <span className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-3 py-1 text-sm text-white/85 backdrop-blur"><span className="mr-2 inline-block h-2 w-2 rounded-full bg-[#8FD14F]"></span>Search Rankings</span>
              <span className="inline-flex items-center rounded-full border border-white/15 bg-white/5 px-3 py-1 text-sm text-white/85 backdrop-blur"><span className="mr-2 inline-block h-2 w-2 rounded-full bg-[#8FD14F]"></span>Social Authority</span>
            </div>
            ...
            <DialogContent className="fixed inset-0 z-50 w-screen h-screen max-w-none left-0 top-0 translate-x-0 translate-y-0 border-0 p-0 rounded-none bg-black/70 data-[state=open]:animate-in data-[state=open]:fade-in-0">
              ...
              <div className="absolute inset-x-0 bottom-0 h-[85vh] md:h-[80vh] bg-gradient-to-b from-zinc-50 to-white text-slate-900 rounded-t-2xl shadow-[0_-20px_60px_rgba(0,0,0,0.5)] data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom-4 overflow-y-auto focus:outline-none">
                <div className="sticky top-0 z-10 flex items-center justify-between px-4 md:px-8 py-4 border-b border-zinc-200 bg-white/85 backdrop-blur">
                  ...
                  <button aria-label="Close" onClick={() => setNoteOpen(false)} className="rounded-full border border-zinc-300 bg-white px-3 py-1.5 text-sm text-zinc-700 hover:bg-zinc-50 shadow-sm">Close</button>
                </div>
