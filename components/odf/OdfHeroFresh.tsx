...
export default function OdfHeroFresh(): JSX.Element {
	const heroBg: React.CSSProperties = {
		background:
			"radial-gradient(900px 360px at 24% 20%, rgba(148,216,45,0.08), transparent 60%), " +
			"linear-gradient(180deg, rgba(4,6,10,1) 0%, rgba(3,5,10,0.96) 50%, rgba(3,4,8,0.94) 100%)",
	};

	const rightHalo: React.CSSProperties = {
		background:
			"radial-gradient(520px 260px at 85% 18%, rgba(148,216,45,0.10), transparent 60%)",
	};

	const creamPanel: React.CSSProperties = {
		background: "linear-gradient(180deg, #F8F5EE, #F3EFE6)",
	};
			...
			<div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 pt-28 md:pt-32 lg:pt-36 pb-12">
				<div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_520px] items-start gap-10 lg:gap-16">
					...
					<div className="relative w-full max-w-[520px] lg:ml-auto">
						<div className="pointer-events-none absolute -inset-8 rounded-3xl" style={rightHalo} />
						<div className="relative rounded-2xl border border-black/5 text-slate-900 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.28)]" style={creamPanel}>
