				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
					...
					<div className="w-full max-w-xl lg:ml-auto">
						...
						<div className="mt-3 flex flex-wrap gap-2">
							<span className="rounded-full bg-white/10 border border-white/15 px-3 py-1 text-sm">AI Citations</span>
							<span className="rounded-full bg-white/10 border border-white/15 px-3 py-1 text-sm">Search Rankings</span>
							<span className="rounded-full bg-white/10 border border-white/15 px-3 py-1 text-sm">Social Authority</span>
						</div>
						...
						<div className="mt-5">
							...
							<a
								...
								className="mt-3 inline-flex w-full items-center justify-center rounded-full border border-white/20 bg-white/10 text-white px-6 py-3 font-semibold hover:bg-white/12"
							>
								Get In Touch
							</a>
						</div>
							...
							<Collapsible open={open} onOpenChange={setOpen}>
								<CollapsibleTrigger className="w-full text-left group">
									<div className="flex items-center justify-between gap-3">
										<p className="font-semibold">AI gave everyone a voice. Now nobody can be heard.</p>
										<ChevronDown className={`h-5 w-5 transition-transform duration-300 ${open ? 'rotate-180' : ''}`} />
									</div>
								</CollapsibleTrigger>
								<CollapsibleContent className="overflow-hidden data-[state=closed]:animate-collapse-up data-[state=open]:animate-collapse-down">
									<div className="pt-3 space-y-3 text-white/85 text-sm leading-relaxed">
